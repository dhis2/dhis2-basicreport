...
console.log("itemify", periods[0].iso, periods);
                ...
                P.prototype.gen = function(type, offset) {
                    return this.generator.generatePeriods(type, offset);
                };

                P.prototype.genRev = function(type, offset) {
                    return this.generator.generateReversedPeriods(type, offset);
                };

                // dep 1

                P.prototype.getItemsByTypeByFinancialApril = function(type, isAll) {
				...
				P.prototype.getItemsByTypeByFinancialJuly = function(type, isAll) {
				...
				P.prototype.getItemsByTypeByFinancialOct = function(type, isAll) {
                ...
                P.prototype.getItemsByTypeByWeek = function(type, isAll) {
                    ...
                    if (type === 'FinancialOct') {
                        ...
                        if (startDateMonth === 12 && endDateMonth === 1) {
                            ...
                            var actualMonthIndexes = Ext.Array.unique([startDateMonth, endDateMonth]);

                            for (var i = 0, monthIndexes = Ext.Array.unique([startDateMonth, endDateMonth]); i < monthIndexes.length; i++) {
